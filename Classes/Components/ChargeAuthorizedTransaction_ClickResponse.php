...
class ChargeAuthorizedTransaction_ClickResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for ChargeAuthorizedTransaction_ClickResponse
     * @uses ChargeAuthorizedTransaction_ClickResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\ChargeAuthorizedTransaction_ClickResponse
     */
