...
class AuthorizeOpportunity_ClickJSONResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for AuthorizeOpportunity_ClickJSONResponse
     * @uses AuthorizeOpportunity_ClickJSONResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\AuthorizeOpportunity_ClickJSONResponse
     */
