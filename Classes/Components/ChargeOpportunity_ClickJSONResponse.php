...
class ChargeOpportunity_ClickJSONResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for ChargeOpportunity_ClickJSONResponse
     * @uses ChargeOpportunity_ClickJSONResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\ChargeOpportunity_ClickJSONResponse
     */
