...
class ChargeAuthorizedTransaction_ClickJSON extends ComponentBase
{
    /**
     * The InputParams
    ...
    public $InputParams;
    /**
     * Constructor method for ChargeAuthorizedTransaction_ClickJSON
     * @uses ChargeAuthorizedTransaction_ClickJSON::setInputParams()
     ...
     * @param string $inputParams
     * @return \Classes\Components\ChargeAuthorizedTransaction_ClickJSON
     */
