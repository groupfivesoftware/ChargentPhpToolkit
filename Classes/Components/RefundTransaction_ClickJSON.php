...
class RefundTransaction_ClickJSON extends ComponentBase
{
    /**
     * The InputParams
    ...
    public $InputParams;
    /**
     * Constructor method for RefundTransaction_ClickJSON
     * @uses RefundTransaction_ClickJSON::setInputParams()
     ...
     * @param string $inputParams
     * @return \Classes\Components\RefundTransaction_ClickJSON
     */
