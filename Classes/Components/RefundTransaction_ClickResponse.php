...
class RefundTransaction_ClickResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for RefundTransaction_ClickResponse
     * @uses RefundTransaction_ClickResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\RefundTransaction_ClickResponse
     */
