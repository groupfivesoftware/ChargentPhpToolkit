...
class ChargeAuthorizedTransaction_ClickJSONResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for ChargeAuthorizedTransaction_ClickJSONResponse
     * @uses
     * ChargeAuthorizedTransaction_ClickJSONResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\ChargeAuthorizedTransaction_ClickJSONResponse
     */
