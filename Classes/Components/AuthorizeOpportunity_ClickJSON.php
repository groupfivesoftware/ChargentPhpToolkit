...
class AuthorizeOpportunity_ClickJSON extends ComponentBase
{
    /**
     * The InputParams
    ...
    public $InputParams;
    /**
     * Constructor method for AuthorizeOpportunity_ClickJSON
     * @uses AuthorizeOpportunity_ClickJSON::setInputParams()
     ...
     * @param string $inputParams
     * @return \Classes\Components\AuthorizeOpportunity_ClickJSON
     */
