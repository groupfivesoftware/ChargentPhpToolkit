...
class RefundOpportunity_Click extends ComponentBase
{
    /**
     * The OpportunityId
    ...
    /**
     * Constructor method for RefundOpportunity_Click
     * @uses RefundOpportunity_Click::setOpportunityId()
     ...
     * @param string $opportunityId
     * @return \Classes\Components\RefundOpportunity_Click
     */
