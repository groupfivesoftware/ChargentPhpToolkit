...
class AuthorizeOpportunity_ClickResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for AuthorizeOpportunity_ClickResponse
     * @uses AuthorizeOpportunity_ClickResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\AuthorizeOpportunity_ClickResponse
     */
