...
class VoidOpportunity_Click extends ComponentBase
{
    /**
     * The OpportunityId
    ...
    /**
     * Constructor method for VoidOpportunity_Click
     * @uses VoidOpportunity_Click::setOpportunityId()
     ...
     * @param string $opportunityId
     * @return \Classes\Components\VoidOpportunity_Click
     */
