...
class VoidTransaction_Click extends ComponentBase
{
    /**
     * The TransactionId
    ...
    /**
     * Constructor method for VoidTransaction_Click
     * @uses VoidTransaction_Click::setTransactionId()
     ...
     * @param string $transactionId
     * @return \Classes\Components\VoidTransaction_Click
     */
