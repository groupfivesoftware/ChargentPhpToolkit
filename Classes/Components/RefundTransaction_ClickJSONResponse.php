...
class RefundTransaction_ClickJSONResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for RefundTransaction_ClickJSONResponse
     * @uses RefundTransaction_ClickJSONResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\RefundTransaction_ClickJSONResponse
     */
