...
class VoidOpportunity_ClickResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for VoidOpportunity_ClickResponse
     * @uses VoidOpportunity_ClickResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\VoidOpportunity_ClickResponse
     */
