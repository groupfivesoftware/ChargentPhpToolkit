...
class VoidTransaction_ClickResponse extends ComponentBase
{
    /**
     * The result
    ...
    public $result;
    /**
     * Constructor method for VoidTransaction_ClickResponse
     * @uses VoidTransaction_ClickResponse::setResult()
     ...
     * Set result value
     * @param \Classes\Components\TChargentResult $result
     * @return \Classes\Components\VoidTransaction_ClickResponse
     */
