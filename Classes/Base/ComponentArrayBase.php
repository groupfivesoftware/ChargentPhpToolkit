...
require_once __DIR__. '/ComponentArrayInterface.php';
abstract class ComponentArrayBase extends ComponentBase implements ComponentArrayInterface
{
    /**
    ...
    /**
     * Method return int intern array index when iterating trough
     * @return int
     */
